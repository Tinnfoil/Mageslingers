...
UCLASS()
class MAGESLINGERS_API AWeaponObject : public AWeaponComponentObject, public IWeapon
{
	GENERATED_BODY()
...
public:	
	...
	UFUNCTION(BlueprintCallable)
 	void SplitWeaponGemData(FString WeaponGemStringData, UStaticMeshComponent* BodyMesh, UStaticMeshComponent* HeadMesh, UStaticMeshComponent* TailMesh);
